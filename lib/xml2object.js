...
var xml2object = module.exports = function(elements, source, opts) {
	elements = elements || [];
	opts = opts || {};
	...
	this.saxStream.on("closetag", function (name) {
		...
		name = opts.xmlns ? name.replace(/.+?:/,'') : name;
